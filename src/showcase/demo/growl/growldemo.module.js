...
var growldemo_routing_module_1 = require("./growldemo-routing.module");
...
GrowlDemoModule = __decorate([
    core_1.NgModule({
        imports: [
            ...
            growldemo_routing_module_1.GrowlDemoRoutingModule,
            growl_1.GrowlModule,
        ...
        declarations: [
            growldemo_1.GrowlDemo
        ]
    }),
    __metadata("design:paramtypes", [])
], GrowlDemoModule);
exports.GrowlDemoModule = GrowlDemoModule;
