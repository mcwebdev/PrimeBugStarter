...
var ratingdemo_routing_module_1 = require("./ratingdemo-routing.module");
...
RatingDemoModule = __decorate([
    core_1.NgModule({
        imports: [
            ...
            forms_1.FormsModule,
            ratingdemo_routing_module_1.RatingDemoRoutingModule,
            rating_1.RatingModule,
            tabview_1.TabViewModule,
            codehighlighter_1.CodeHighlighterModule
        ],
        declarations: [
            ratingdemo_1.RatingDemo
        ]
    }),
    __metadata("design:paramtypes", [])
], RatingDemoModule);
exports.RatingDemoModule = RatingDemoModule;
